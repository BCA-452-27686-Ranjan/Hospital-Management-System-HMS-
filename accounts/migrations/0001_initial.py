# Generated by Django 4.2.7 on 2026-02-06 16:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('specialization', models.CharField(choices=[('CARD', 'Cardiologist'), ('NEUR', 'Neurologist'), ('ORTH', 'Orthopedic'), ('PED', 'Pediatrician'), ('DERM', 'Dermatologist'), ('GEN', 'General Physician'), ('GYN', 'Gynecologist'), ('OPH', 'Ophthalmologist'), ('ENT', 'ENT Specialist'), ('PSY', 'Psychiatrist')], max_length=20)),
                ('license_number', models.CharField(max_length=50, unique=True)),
                ('experience_years', models.PositiveIntegerField(default=0)),
                ('qualification', models.CharField(max_length=200)),
                ('consultation_fee', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('available_days', models.CharField(help_text='Comma separated days: Mon,Tue,Wed,Thu,Fri,Sat,Sun', max_length=100)),
